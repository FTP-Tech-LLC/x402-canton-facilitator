  ...
  return {
    async create(rec) {
      ...
      await executor.query(
        "INSERT INTO tf_stash(ref, payer, receiver, amount, instrument_admin, instrument_id, execute_before, tx_hash, prepared_tx) " +
    ...
    async get(ref) {
      ...
      const r = await executor.query(
        "SELECT ref, payer, receiver, amount, instrument_admin, instrument_id, execute_before, tx_hash, prepared_tx, signature, settled_update_id " +
